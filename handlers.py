...
try:
    ...
    print("⚠️ Russian locale not available, using default")
...
SYSTEM_PROMPT = f"""
Today is {today}.
You are a helpful Telegram bot assistant that explains GoCrowd.io contract and payment information to the user in plain Russian. The user is a lender to companies.
...
- Repayment_start_month indicates the number of the payout month when the principal starts to get paid out in equal parts.
...
async def ask(update: Update, context: ContextTypes.DEFAULT_TYPE) :
    print("Deploy version 4 at 2025-07-11 12:34")
